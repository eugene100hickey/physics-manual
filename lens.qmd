...
From the cornea in your eye to the camera of your phone, a lens is a critical component of most optical systems. And for a lens, its focal length is key parameter dictating its performance. In today's experiment we will measure the focal length of a convex (converging, thicker in the center than at the edges) lens.
...
z <- tibble(u = c(25.0, 27.0, 30.0, 35.0, 42.0, 50.0, 70, 100), 
            v = rep("", 8), 
            u_1 = (1/u) |> signif(3), 
            v_1 = rep("", 8)
             )
